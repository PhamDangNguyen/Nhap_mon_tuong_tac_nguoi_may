...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi('temp.ui', self) # Load the .ui file
    ...
    def change_robot(self):
        ...
        # if (self.cus_change.isChecked()) self.canvas.change_robot(robot_class.Robot5DOF())


    def tabViewInitial(self):
        self.canvas = testMatlab.DrawWidget()
    ...
    def adaptJointID(self):
        ...
        self.tempPopup.JointhTargetValue.setMaximum(self.canvas.robot.limit[jID][1])
        self.tempPopup.JointhTargetValue.setMinimum(self.canvas.robot.limit[jID][0])
